...
<div class="g-grid">
<a rel="0" href="http://www.yuhailin.com" class="btn-banner" target="_blank" style="display:block;">查看详情</a>
<a rel="1" href="http://www.yuhailin.com" class="btn-banner" target="_blank" style="display:;">查看详情</a>
<a rel="2" href="http://www.yuhailin.com" class="btn-banner" target="_blank" style="display:;">查看详情</a>
<a rel="3" href="http://www.yuhailin.com" class="btn-banner" target="_blank" style="display:;">查看详情</a>
<a rel="4" href="http://www.yuhailin.com" class="btn-banner" target="_blank" style="display:;">查看详情</a>
<a rel="5" href="http://www.yuhailin.com" class="btn-banner" target="_blank" style="display:;">查看详情</a>
    ...
    <div class="wrap clear">
        ...
        <div class="con1f left">
            ...
            <?php if(is_array($a)): foreach($a as $key=>$b): ?><li>
               		...
               		<a href="<?php echo U('Item/index',array('id'=>$b['p_id']));?>"><?php echo ($b["p_name"]); ?></a>
        ...
        <div class="con1rt right">
            <div><a href="javascript:void(0)" ><img src="/Upload/product/201609161637356343.jpg" alt=""/></a></div>
            <div class="dynamic clear">
                ...
                <ul>
                    ...
                    <li>
                        <span>[<a>行业新闻</a>]</span>
                        <a href="/Home/Article/index?id=1" title="两分钟内切整个菠萝，这方法太好用!" target="_blank">两分钟内切整个菠萝，这方法太好用!</a>
                        
                    </li>
                    
                    <li>
                        <span>[<a>养生保健</a>]</span>
                        <a href="/Home/Article/index?id=2" title="我和你缠缠绵绵，丝丝入味" target="_blank">我和你缠缠绵绵，丝丝入味</a>
                        
                    </li>
                    
                    <li>
                        <span>[<a>养生保健</a>]</span>
                        <a href="/Home/Article/index?id=3" title="4款春季减肥食品 多吃不胖" target="_blank">4款春季减肥食品 多吃不胖</a>
                        
                    </li>
                    
                    <li>
                        <span>[<a>养生保健</a>]</span>
                        <a href="/Home/Article/index?id=4" title="豆浆的5大误解，你上当没？" target="_blank">豆浆的5大误解，你上当没？</a>
  ...
  <!--水果蔬菜-->
    <div class="wrap clear" id="floor1">
        <div class="titc tit1 clear"><em class="right">
                                         ...
                                         <a href="<?php echo U('Item/index',array('id'=>5));?>" target="_blank">苹果</a>
                                         <a href="<?php echo U('Item/index',array('id'=>11));?>" target="_blank">榴莲</a>
                                         <a href="<?php echo U('Item/index',array('id'=>7));?>" target="_blank">山竹</a>
                                         <a href="<?php echo U('Category/index',array('id'=>1));?>" target="_blank">更多</a>
            </em><i></i><b>水果蔬菜</b></div>
        <div class="FruitVeg">
            <div class="FruitVeglf left">
                <div class="FruitVegpic lfcomc clear"><a href="<?php echo U('Category/index',array('id'=>1));?>" target="_blank"><img src="/Upload/product/201605261726149325.jpg" alt=""/></a><p>
                    <em><i class="i1"></i><a href="<?php echo U('Category/index',array('id'=>6));?>" target="_blank">水果</a></em>
                    <em><i class="i2"></i><a href="<?php echo U('Category/index',array('id'=>7));?>" target="_blank">蔬菜</a></em>
                    </p></div>
                <div class="FruitVegtxt clear">
                    <div class="left">
                        <p><em><a href="javascript:void(0)" >苹果</a></em>
                        <em><a href="javascript:void(0)" >榴莲</a></em>
                        <em><a href="javascript:void(0)" >金枕榴莲</a></em>
                        <em><a href="javascript:void(0)" >山竹</a></em>
                        <em><a href="javascript:void(0)" >奇异果</a></em>
                         <em><a href="javascript:void(0)" >车厘子</a></em></p>
                    </div>
                    <div class="left">
                        <p><em><a href="javascript:void(0)" >有机蔬菜</a></em>
                        <em><a href="javascript:void(0)" >瓜果类</a></em>
                        <em><a href="javascript:void(0)" >叶菜类</a></em>
                        <em><a href="javascript:void(0)" >根茎类</a></em>
                        <em><a href="javascript:void(0)">葱姜蒜椒</a></em>
                        <em><a href="javascript:void(0)" >菌菇类</a></em></p>
                    </div>
                </div>
                <div class="botp clear"><a href="<?php echo U('Category/index',array('id'=>7));?>" target="_blank"><img src="/Upload/product/201605271117384118.jpg" alt=""/></a></div>
            </div>
            <div class="FruitVegrt right">
                <ul>
                    <li class="lbig">
                        <p><a href="<?php echo U('Category/index',array('id'=>6));?>" ><img src="/Upload/product/201610261625495442.jpg" alt=""/></a></p>
                        <div id="slideBox" class="slideBox botp slidepic1">
                            <div class="hd"><em>1</em></div><div class="bd"><p><a href="<?php echo U('Category/index',array('id'=>1));?>" target="_blank"><img src="/Upload/product/201701191646028728.jpg"/></a></p></div>
                        </div>
                        <p class="botp"><a href="<?php echo U('Category/index',array('id'=>1));?>" target="_blank"><img src="/Upload/product/201605271150499545.jpg" alt=""/></a></p>
                    </li>
                    <li>
        ...
        <div class="brand clear">
          <ul>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605261838187358.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301716443453.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301702219649.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301702386119.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301702597631.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301703155120.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301703473738.jpg" alt=""/></a></li>
            </ul> 
        </div>
    </div>
    <!--水果蔬菜结束-->
   ...
   <!--肉蛋禽类-->
    <div class="wrap clear" id="floor2">
        <div class="titc tit2 clear"><em class="right">
                                         <a href="<?php echo U('Category/index',array('id'=>33));?>" target="_blank">牛肉</a>
                                         <a href="<?php echo U('Category/index',array('id'=>34));?>" target="_blank">猪肉</a>
                                           <a href="<?php echo U('Category/index',array('id'=>38));?>" target="_blank">鱼</a>
                                         <a href="<?php echo U('Category/index',array('id'=>39));?>" target="_blank">虾</a>
                                         <a href="<?php echo U('Category/index',array('id'=>2));?>" target="_blank">更多选项</a></em><i></i><b>肉类海鲜</b></div>
        <div class="con3">
            <div class="con3lf left">
                ...
                <div class="con3lftxt clear">
                    <div class="left">
                        <p><em><a href="javascript:void(0)">猪肉</a></em>
                        <em><a href="javascript:void(0)">羊肉</a></em>
                        <em class="em1"><a href="javascript:void(0)">鸭肉</a></em>
                        <em><a href="javascript:void(0)">牛肉</a></em>
                        <em><a href="javascript:void(0)">鸡肉</a></em>
                        <em class="em1"><a href="javascript:void(0)">鸭肉</a></em>
                        <em><a href="javascript:void(0)">土鸡蛋</a></em>
                        <em><a href="javascript:void(0)">香辣肠</a></em>
                        <em class="em1"><a href="javascript:void(0)">海鲜礼盒</a></em></p>
                    </div>
                </div>
            </div>
    ...
    <div class="wrap ads clear"><a href="javascript:void(0)"><img src="/Upload/product/201612140915369482.jpg" alt=""/></a></div>
    ...
    <div class="wrap clear" id="floor3">
        <div class="titc tit3 clear">
            <em class="right">
                <a href="http://www.yuhailin.com/category.aspx?wd=巧克力" target="_blank">巧克力</a>
                <a href="http://www.yuhailin.com/category.aspx?wd=进口零食" target="_blank">进口零食</a>
                <a href="http://www.yuhailin.com/category-291.aspx" target="_blank">糖果</a>
                <a href="http://www.yuhailin.com/category-168.aspx" target="_blank">蜜饯果干</a>
                <a href="http://www.yuhailin.com/category-171.aspx" target="_blank">蛋糕饼干</a>
                <a href="http://www.yuhailin.com/category-167.aspx" target="_blank">坚果炒货</a>
                <a href="http://www.yuhailin.com/category-34.aspx" target="_blank">更多选项</a></em><i></i><b>休闲食品</b>
        </div>
        <div class="FruitVeg">
            <div class="FruitVeglf left">
        ...
        <div class="brand clear">
            <ul>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301714546390.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301719022312.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301719403413.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201606211456141381.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301722156212.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301723164967.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);" ><img src="/Upload/product/201605301724389134.jpg" alt=""/></a></li>
            </ul>
        </div>
    </div>
    <!--休闲食品结束-->
    ...
    <div class="wrap clear" id="floor4">
        <div class="titc tit4 clear"><em class="right">
                                         <a href="http://www.yuhailin.com/category-242.aspx" target="_blank">干货</a>
                                         <a href="http://www.yuhailin.com/category-245.aspx" target="_blank">食用油</a>
                                         <a href="http://www.yuhailin.com/category-183.aspx" target="_blank">厨房调料</a>
                                         <a href="http://www.yuhailin.com/category-244.aspx" target="_blank">粗粮</a>
                                         <a href="http://www.yuhailin.com/category-590.aspx" target="_blank">调味酱</a>
                                         <a href="http://www.yuhailin.com/category-243.aspx" target="_blank">米面</a>
                                         <a href="http://www.yuhailin.com/category-33.aspx" target="_blank">更多选项</a></em><i></i><b>粮油副食</b></div>
        <div class="con3">
        ...
        <div class="brand clear">
            <ul>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301730127325.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301732522626.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301734392177.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301735412983.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301737013649.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301739107903.jpg" alt=""/></a></li>
                <li><a href="javascript:void(0);"><img src="/Upload/product/201605301738322591.jpg" alt=""/></a></li>
            </ul>
        </div>
    </div>
    <div class="wrap ads clear"><a href="#"><a href="javascript:void(0);"><img src="/Upload/product/201605261835490333.jpg" alt=""/></a></a></div>
    <!--粮油副食结束-->

    <!--茶叶冲饮-->
    <div class="wrap clear" id="floor5">
        <div class="titc tit5 clear"><em class="right">  
                                         <a href="http://www.yuhailin.com/category.aspx?wd=蜂蜜" target="_blank">蜂蜜</a>
                                         <a href="http://www.yuhailin.com/category-381.aspx" target="_blank">红茶</a>
                                         <a href="http://www.yuhailin.com/category.aspx?wd=铁观音" target="_blank">铁观音</a>
                                         <a href="http://www.yuhailin.com/category.aspx?wd=牛奶" target="_blank">牛奶</a>
                                         <a href="http://www.yuhailin.com/category.aspx?wd=麦片" target="_blank">麦片</a>
                                         <a href="http://www.yuhailin.com/category.aspx?wd=咖啡" target="_blank">咖啡</a>
                                         <a href="http://www.yuhailin.com/category.aspx?wd=普洱" target="_blank">普洱</a>
                                         <a href="http://www.yuhailin.com/category-35.aspx" target="_blank">更多选项</a></em><i></i><b>茶叶冲饮</b></div>
        <div class="FruitVeg">
            <div class="FruitVeglf left">
